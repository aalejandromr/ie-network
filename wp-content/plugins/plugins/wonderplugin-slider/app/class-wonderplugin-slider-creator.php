				...
				<div class="wonderplugin-slider-options">
					...
					<div class="wonderplugin-slider-options-tabs" id="wonderplugin-slider-options-tabs">
						...
						<div class="wonderplugin-slider-options-tab">
							<table class="wonderplugin-form-table-noborder">
								<tr>
									...
									<input class="button button-secondary" type="button" id="save-text-effect" value="Save as a new text effect">
									<input class="button button-secondary" type="button" id="save-current-text-effect" value="Save text effect">
									<input class="button button-secondary" type="button" id="delete-current-text-effect" value="Delete text effect">
						...
						<ul class="wonderplugin-tab-buttons-horizontal" data-panelsid="wonderplugin-lightbox-panels">
							...
							<li class="wonderplugin-tab-button-horizontal"></span><?php _e( 'Thubmails', 'wonderplugin_slider' ); ?></li>
